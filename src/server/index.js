            ...
            if (tmpArray) {
              tmpArray.forEach((tmp) => {
                ...
                switch (c) {
                  ...
                  // 客勝
                  case 402:
                    if (obj.rates[obj.rates.length - 1].hi !== tmp.oddPerSet[1]) {
                      isChange = true;
                    }
                    break;
                  ...
                  // 合局
                  case 401:
                    if (obj.rates[obj.rates.length -1 ].draw !== tmp.oddPerSet[1]) {
                      isChange = true;
                    }
                    break;
                  ...
                  // 主勝
                  case 400:
                  if (obj.rates[obj.rates.length -1 ].ai !== tmp.oddPerSet[1]) {
                    isChange = true;
                  }
                    break;
                }
